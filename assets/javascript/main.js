// judul
document.title = "Portofolio Warsa";
...
// Mendapatkan konteks 2D dari elemen canvas dengan ID 'canvasFront'
var ctx_frontEnd = document.getElementById('canvasFront').getContext('2d');

// Mendapatkan konteks 2D dari elemen canvas dengan ID 'canvasBack'
